  ...
  return (
    <div className="flex items-center justify-between border-b py-4">
      ...
      <div className="flex-1 gap-[10px] ml-4">
        ...
        <h3 className="text-[14px] leading-[21px]  font-nomral ">
          {item.price}
        </h3>

        <div className="flex items-center mt-2">
          <div className="border rounded-[4px]">
            <button className="px-2  text-[14px] leading-[21px]  font-nomral">
              -
            </button>
            <span className="mx-2 text-[14px] leading-[21px]  font-nomral">
              {item.quantity || "12"}
            </span>
            <button className="mx-2 text-[14px] leading-[21px]  font-nomral">
              +
            </button>
          </div>
