...
function Dashboard() {
  return (
    <div className="bg-[#F5E0E5] lg:py-[102px] py-[78px] relative">
      ...
      />
      <Wrapper>
        <div className="lg:max-w-[562px] md:max-w-[212px] min-w-[179px] relative z-10 flex flex-col lg:gap-[20px] gap-[30px]">
          ...
          <Button className="lg:max-w-[212px]  max-w-[179px] w-full lg:mt-[34px] text-[14px] text-[#FFFFFF] font-semibold lg:p-[10px] px-[10px] py-[8px]">
            Shop Now
          </Button>
        </div>
      </Wrapper>
